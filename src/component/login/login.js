...
function Login() {
    ...
    const post = async(e) => {
     ...
     try {
         const posts = await axios.post(`https://ecommercewebbackend.vercel.app/api/signin`, 
         { email, password});
         if(posts.status === 201){
           notify()
  ...
  return (
    ...
    <div className="container-fluid h-custom">
      <div className="row d-flex justify-content-center align-items-center h-100" >
        ...
        <h2 id="aoo-">Ecom</h2>
          <h3 id="aoos">Signin</h3>
          <h3 id="aooss">Page</h3>
        </div>
        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form onSubmit={post}>
          <h3 id="asxa">Ecom Signin </h3>
            ...
            <div className="text-center text-lg-start mt-4 pt-2">
              ...
              <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="/"
                  className="link-danger">Register</a></p>
                   <p className="small fw-bold mt-2 pt-1 mb-0"><a href="/forgot-password"
                  className="link-danger">Forgot-Password</a></p>
            </div>
          </form>
